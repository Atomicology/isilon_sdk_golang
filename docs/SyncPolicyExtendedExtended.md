...
**HasSyncState** | **bool** | This field is false if the policy is in its initial sync state and true otherwise.  Setting this field to false will reset the policy&#39;s sync state. | [optional] [default to null]
...
**LastJobState** | **string** | This is the state of the most recent job for this policy. | [optional] [default to null]
