 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return */
func (a *DebugApiService) DeleteDebugStats(ctx context.Context) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/platform/1/debug/stats"
